...
namespace Code.Runtime.Skeletons {
    public class SpawnManager : MonoBehaviour {
        [SerializeField] private SkeletonSpawner[] spawners;
        [SerializeField] private GameObject        playerPrefab;
        [SerializeField] private float             secondsBetweenSpawn    = 10;
        [SerializeField] private int               maxSpawnersUsedAtATime = 3;
        [SerializeField] private int               maxGlobalSkeletonSpawn = 20;
            ...
            try {
                for (int i = 0; i < batchSpawnAmount; i++) {
                    ...
                    if (spawnPos != Vector3.zero && numberSpawned < ScoreController.current.numOfEnemies && numberSpawned < maxGlobalSkeletonSpawn) {
                        ...
                        newEnemy.GetComponent<SkeletonExplode>().spawner = spawner;
